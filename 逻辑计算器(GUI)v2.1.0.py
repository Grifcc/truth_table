...
def kar_show(var,res,flag,s):
    ...
    row_gray=GrayCode().getGray(row)
    col_gray=GrayCode().getGray(col)
...
def Truth_tab():
    ...
    w = Label(root, fg='black', text="copyright@CGC  ver  2.1.0", font=('Arial', 12), justify="right",
                      bg="Gainsboro")
    w.pack(side='bottom')
